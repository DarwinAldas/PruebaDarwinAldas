...
public class DepartamentoConverter implements Converter {
    ...
    private static final Logger LOGGER = Logger.getLogger(DepartamentoConverter.class.getName());
    //</editor-fold>
    ...
    public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) throws ConverterException {
        ...
        if (arg2.trim().equals("") || arg2.equals("null")) {
            ...
            return new Departamento(Integer.valueOf(arg2));
        }
    ...
    public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2)
        ...
        if (arg2 == null || arg2.equals("")) {
            ...
            return String.valueOf(((Departamento) arg2).getIdDepartamento());
        }
    }
    //</editor-fold>
